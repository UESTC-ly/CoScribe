...
| 系统 | 安装包 | 适用范围 |
| --- | --- | --- |
| macOS | `CoScribe-1.0.0-arm64.dmg` | Apple Silicon，macOS 13+ |
| macOS | `CoScribe-1.0.0-arm64-mac.zip` | Apple Silicon 免安装压缩包 |
| Windows | `CoScribe-Setup-1.0.0.exe` | Windows 10/11 x64 |
...
| --- | --- | --- |
| macOS | `CoScribe-1.0.0-arm64.dmg` | Apple Silicon, macOS 13+ |
| macOS | `CoScribe-1.0.0-arm64-mac.zip` | Portable Apple Silicon archive |
| Windows | `CoScribe-Setup-1.0.0.exe` | Windows 10/11 x64 |
