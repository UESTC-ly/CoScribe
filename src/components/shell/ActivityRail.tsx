import { Bot, FileText, Highlighter, MessageSquareText, PanelRight, Search, Settings } from 'lucide-react'
...
export function ActivityRail({ active, aiVisible, onChange, onToggleAi, onSettings }: ActivityRailProps): React.JSX.Element {
  return (
